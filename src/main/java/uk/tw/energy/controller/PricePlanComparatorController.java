...
public class PricePlanComparatorController {
    ...
    public static final String NO_COST_ERROR_MESSAGE = "No readings found for provided plan.";
    ...
    /**
     * In order to simplify the request our assumption is that we will calculate last week from today's date and it
     * perform the filtering of out of scope readings.
     *
     * @param smartMeterId
     * @return Total cost of previous week consumption.
     */
    @GetMapping("/previousWeekCost/{smartMeterId}")
    public ResponseEntity<Cost> previousWeekCost(@PathVariable String smartMeterId){
